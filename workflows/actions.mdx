...
<Note>
Actions can be combined and customized in any workflow. For inspiration, see the <a href="/workflows/workflow-templates">Templates</a> page, or visit the <a href="/workflows/overview">Workflows Overview</a> for a step-by-step guide.
</Note>
